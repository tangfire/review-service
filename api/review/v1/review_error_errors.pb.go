...
func IsOrderReview(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_ORDER_REVIEW.String() && e.Code == 400
}

func ErrorOrderReview(format string, args ...interface{}) *errors.Error {
	return errors.New(400, ErrorReason_ORDER_REVIEW.String(), fmt.Sprintf(format, args...))
}
