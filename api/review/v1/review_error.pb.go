...
const (
	...
	ErrorReason_ORDER_REVIEW ErrorReason = 100
)
...
const file_api_review_v1_review_error_proto_rawDesc = "" +
	"\n" +
	" api/review/v1/review_error.proto\x12\rapi.review.v1\x1a\x13errors/errors.proto*V\n" +
	"\vErrorReason\x12\x14\n" +
	"\n" +
	"NEED_LOGIN\x10\x00\x1a\x04\xa8E\x91\x03\x12\x13\n" +
	"\tDB_FAILED\x10\x01\x1a\x04\xa8E\xf4\x03\x12\x16\n" +
	"\fORDER_REVIEW\x10d\x1a\x04\xa8E\x90\x03\x1a\x04\xa0E\xf4\x03B2\n" +
